...
Public Class Class1
    Public Function Loadkhachang() As DataSet
        Dim chuoiketnoi As String = "workstation id=PS03761Final.mssql.somee.com;packet size=4096;user id=phongbt;pwd=123@abcd;data source=PS03761Final.mssql.somee.com;persist security info=False;initial catalog=PS03761Final"
